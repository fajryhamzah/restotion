                ...
                <div class="ui form">
                  <div class="fields">
                    <div class="inline field">
                      ...
                      <input placeholder="Nama Meja" value="{{ $info->nama_meja }}" name="nama" type="text" required>
                    </div>
                    <div class="inline field">
                      <label>Kapasitas</label>
                      <div class="ui right labeled input">
                        <label for="amount" class="ui label">Jumlah</label>
                        <input min="0" placeholder="Kapasitas" type="number" name="kapasitas" value="{{ $info->kapasitas }}">
                  ...
                  <div class="field">
                    ...
                    <textarea rows="2" name="detail" placeholder="Deskripsi meja">{{ $info->keterangan }}</textarea>
                  </div>
                  {{ csrf_field() }}
